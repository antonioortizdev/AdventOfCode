...
for (let num of input) {
  ...
  if (complement[toFind]) 
    console.log('part1', num * toFind); // 1005459
}
...
for (let numA of input)
    for(let numB of input) 
        for(let numC of input) {
            ...
            const areDifferent = new Set(arr).size === 3
            if(areDifferent && sum === 2020) {
                console.log('part2', arr.reduce((acc, cur) => acc * cur)) // 92643264
                break
            }
